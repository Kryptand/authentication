...
@Component({
  tag: 'kryptand-external-logins',
  styleUrl: 'external-logins.css',
  shadow: true,
})
export class ExternalLogins {
  @Event() googleButtonClicked: EventEmitter;
  @Event() facebookButtonClicked: EventEmitter;
  @Event() twitterButtonClicked: EventEmitter;
  @Event() githubButtonClicked: EventEmitter;
  render() {
    return (
      <host>
        <div class="social-logins">
          <kryptand-translate name="continueWithSocialProfiles" />
        </div>
        <div class="login-buttons">
          <svg
            aria-role="button"
            onClick={() => this.googleButtonClicked.emit()}
            width="43"
            height="43"
            viewBox="0 0 43 43"
            fill="none"
          ...
          <svg
            aria-role="button"
            onClick={() => this.facebookButtonClicked.emit()}
            width="43"
            height="43"
            viewBox="0 0 43 43"
            fill="none"
          ...
          <svg
            aria-role="button"
            onClick={() => this.twitterButtonClicked.emit()}
            width="43"
            height="43"
            viewBox="0 0 43 43"
            fill="none"
          ...
          <svg
            aria-role="button"
            onClick={() => this.githubButtonClicked.emit()}
            width="43"
            height="43"
            viewBox="0 0 43 43"
            fill="none"
